    ...
    return (
        <div className="flex flex-wrap items-end justify-between gap-3">
            <div className="min-w-0">
                {eyebrow && (
                    <p className="mb-1 text-[10px] font-semibold tracking-[0.14em] text-stone-400 uppercase dark:text-slate-500">
                        {eyebrow}
                    </p>
                )}
                ...
                {description && (
                    <p className="mt-1 max-w-2xl text-[13px] leading-snug text-stone-500 dark:text-slate-400">
                        {description}
                    </p>
                )}
            </div>
