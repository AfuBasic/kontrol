        ...
        <div className="w-full">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className={`block w-full rounded-2xl border-0 bg-slate-50 py-5 pl-14 pr-8 text-slate-900 ring-1 ring-slate-200 transition-all focus:bg-white focus:ring-2 focus:ring-[#1F6FDB] ${className}`}
