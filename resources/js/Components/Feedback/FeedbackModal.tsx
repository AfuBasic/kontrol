    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} maxWidth="lg">
            <div className="space-y-5">
                <div>
                    <h3 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Share Feedback with Kontrol</h3>
                    <p className="mt-1 text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                        Help us improve Kontrol. This goes directly to the product engineering team. (For urgent account issues, please use Support
                        options instead.)
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <div className="mt-0.5 line-clamp-1 text-[11px] leading-snug text-slate-500 dark:text-slate-400">
                                                {cat.description}
                                            </div>
                                        </div>
                                    </button>
                    ...
                    <div>
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-[11px] text-slate-400 tabular-nums">{message.length} / 2,000</span>
                        </div>
                        <div className="mt-2">
                            <textarea
                                id="feedback-message"
                                ...
                                className="block w-full rounded-2xl border border-slate-200 bg-white p-3.5 text-xs text-slate-900 shadow-xs placeholder:text-slate-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:border-slate-800 dark:bg-slate-900 dark:text-white dark:placeholder:text-slate-500"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-2.5 pt-2">
                        <button
                            ...
                            className="rounded-xl px-4 py-2.5 text-xs font-medium text-slate-600 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-xs font-semibold text-white shadow-xs transition hover:bg-slate-800 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
                        >
                            {isSubmitting ? (
                                <>
