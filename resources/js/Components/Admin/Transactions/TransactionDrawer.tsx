...
export default function TransactionDrawer({ transactionUlid, open, onClose, permissions }: Props) {
    ...
    const downloadPdf = () => {
        ...
        const formattedDate = transaction.paid_at ? format(parseISO(transaction.paid_at), 'PPP p') : 'N/A';
            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        .status { display: inline-block; background: #ecfdf5; color: #065f46; font-size: 11px; font-weight: bold; padding: 4px 8px; border-radius: 6px; margin-top: 10px; text-transform: uppercase; }
                        ...
                        .amount { font-size: 32px; font-weight: 800; color: #0f172a; margin-top: 20px; }
                        @media print {
                            body { padding: 20px; }
                        }
                    </style>
                ...
                <body>
                    <div class="header">
                        <div class="title">Ledger Receipt</div>
                        <div style="font-size: 14px; color: #64748b;">Ref: ${transaction.reference_number}</div>
                        <div class="status">${transaction.status_label || 'Successful'}</div>
                    </div>
                    
                    <div class="amount">
                        ${formattedAmount}
                    </div>
                    <div style="font-size: 14px; color: #64748b; margin-bottom: 35px; font-weight: 600;">
                        ${transaction.type_label}
                    </div>

                    <div class="details">
                        <div class="row">
                            <div class="label">Resident / Owner</div>
                            <div class="value">${transaction.resident?.name || 'Resident'}</div>
                        </div>
                        <div class="row">
                            <div class="label">Email</div>
                            <div class="value">${transaction.resident?.email || 'N/A'}</div>
                        </div>
                        <div class="row">
                            <div class="label">Description</div>
                            <div class="value">${transaction.description || 'System Entry'}</div>
                        </div>
                        <div class="row">
                            <div class="label">Payment Method</div>
                            <div class="value">${transaction.payment_method_label || 'N/A'}</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="value">${transaction.gateway_reference || 'N/A'}</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="label">Date Cleared</div>
