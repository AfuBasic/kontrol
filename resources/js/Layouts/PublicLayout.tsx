...
export default function PublicLayout({ children }: Props) {
    ...
    const toggleTheme = () => {
        ...
        // Phase 1: Trigger tactile feedback and transition class triggers
        document.documentElement.classList.add('theme-transforming');

        const newTheme = theme === 'dark' ? 'light' : 'dark';

        // Phase 4: Swap css class variable theme context at the sweep midpoint
        setTimeout(() => {
            setTheme(newTheme);
        ...
        // Phase 5: Settle scale down blur and transition classes
        setTimeout(() => {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-50">
            {/* Ambient theme sweep element */}
            <div className="theme-light-sweep" />

            <div className="theme-wrapper flex min-h-screen flex-col">
                {/* Navigation */}
                <motion.header
                    ...
                    <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
                        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                            ...
                            <p className="text-sm text-slate-400 dark:text-slate-500">
                                &copy; {currentYear} Afutunde Solutions. All rights reserved.
                            </p>
                        </div>
                    </div>
                </footer>
