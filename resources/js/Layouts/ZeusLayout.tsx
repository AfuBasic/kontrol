...
const baseNavItems: NavItem[] = [
    ...
    { name: 'Settlements', href: '/zeus/settlements', icon: ScaleIcon },
    ...
    { name: 'Coupons', href: '/zeus/coupons', icon: TicketIcon },
...
export default function ZeusLayout({ children, backUrl: _backUrl }: Props) {
