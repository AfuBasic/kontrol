            ...
            >
                <div>
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900">
                        Strategic <span className="text-slate-400 font-light">Referrers</span>
                    </h1>
                </div>
                <Link
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {referrers.data.length === 0 ? (
                                ...
                                referrers.data.map((referrer) => (
                                    <tr key={referrer.id} className="bg-white hover:bg-slate-50/50 transition-colors">
                                        <td className="px-6 py-5">
                                            <div>
                                                ...
                                                {referrer.contact_person && (
                                                    <p className="text-[10px] text-slate-400 mt-0.5">Attn: {referrer.contact_person}</p>
                                                )}
                                            </div>
                                        </td>
                                        <td className="px-6 py-5">
