        ...
        <AdminLayout>
            ...
            <div className="mb-8 flex items-center gap-4">
                <Link
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-gray-500 shadow-sm ring-1 ring-gray-200 transition-colors hover:bg-gray-50"
                >
                ...
                {residents.data.length > 0 ? (
                    <table className="w-full text-left">
                        <thead className="border-b border-gray-200 bg-gray-50">
                            <tr>
                                <th className="px-6 py-4 text-xs font-semibold tracking-wider text-gray-500 uppercase">Resident Details</th>
                                <th className="px-6 py-4 text-xs font-semibold tracking-wider text-gray-500 uppercase">Contact Info</th>
                                <th className="px-6 py-4 text-xs font-semibold tracking-wider text-gray-500 uppercase">Submitted</th>
                                        ...
                                        <td className="px-6 py-5 text-right whitespace-nowrap">
                                            <div className="flex justify-end gap-2">
                                                <button
                                                    ...
                                                    className="flex h-9 w-9 items-center justify-center rounded-lg border border-red-200 bg-white text-red-600 shadow-xs transition-colors hover:bg-red-50 hover:text-red-700 disabled:opacity-50"
                                                ...
                                                <button
                                                    ...
                                                    disabled={processingId === resident.id}
                                                    className="flex items-center gap-1.5 rounded-lg bg-primary-600 px-4 py-2 text-sm font-semibold text-white shadow-xs transition-colors hover:bg-primary-700 disabled:opacity-50"
                                                >
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        {search && (
                            <button onClick={() => setSearch('')} className="mt-4 text-sm font-semibold text-primary-600 hover:text-primary-700">
                                Clear search
                            </button>
                        )}
                    </div>
