            ...
            <div className="flex min-h-screen">
                ...
                <div className="hidden w-1/2 bg-gray-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
                        ...
                        <p className="max-w-md text-lg text-gray-400">A modern platform for estate management, security, and resident services.</p>
                    </motion.div>
                        ...
                        >
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 transition-colors focus:border-gray-900 focus:ring-1 focus:ring-gray-900 focus:outline-none"
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full rounded-lg bg-gray-900 px-4 py-3 text-sm font-medium text-white transition-all hover:bg-gray-800 focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                {processing ? (
