        ...
        <div className="space-y-6 pb-24">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Create and track rent, utility, and generator fee collections.
                    </p>
                </div>
                <Link
                    href={create.url()}
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {collections.length > 0 ? (
                    collections.map((col) => {
                        const collectedPct = col.assignments_count > 0 
                            ? Math.round((col.paid_count / col.assignments_count) * 100) 
                            : 0;
                            ...
                            >
                                <div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="mt-1.5 flex items-center gap-1.5 text-xs text-slate-400 font-bold">
                                    ...
                                    <div className="mt-5 space-y-2">
                                        <div className="flex items-center justify-between text-xs">
                                            <span className="text-slate-400 font-bold uppercase">Payment Progress</span>
                                            <span className="font-bold text-slate-900">{collectedPct}% ({col.paid_count}/{col.assignments_count})</span>
                                        </div>
                    ...
                    <div className="col-span-full rounded-[32px] bg-white py-16 text-center shadow-xs ring-1 ring-slate-100">
                        <WalletIcon className="mx-auto h-12 w-12 text-slate-350" />
                        <h3 className="mt-4 text-lg font-black text-slate-900">No Bills Created</h3>
                        <p className="mt-1 text-sm text-slate-500">
                            You haven't setup any payment collection sheets yet.
                        </p>
                        <Link
                            href={create.url()}
