        ...
        <div className="space-y-6 pb-24">
            ...
            <div className="relative overflow-hidden rounded-[32px] bg-linear-to-br from-indigo-900 to-indigo-950 p-6 text-white shadow-xl shadow-indigo-950/20 sm:p-8">
                <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <span className="rounded-full bg-indigo-500/20 px-3 py-1 text-xs font-bold tracking-wider text-indigo-300 uppercase">
                            Property Owner
                        </span>
                        <h1 className="mt-2 text-2xl font-black tracking-tight sm:text-3xl">Estate Hub</h1>
                        <p className="mt-1 text-sm text-indigo-200/80">Monitor and manage your property holdings and occupants.</p>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                ...
                >
                    <div className="flex items-center justify-between">
                        ...
                        <ChevronRightIcon className="h-4 w-4 text-slate-400 opacity-0 transition-all group-hover:translate-x-1 group-hover:opacity-100" />
                    </div>
                    <div className="mt-4">
                        <p className="text-2xl font-black text-slate-900">{propertiesCount}</p>
                        <p className="text-xs font-bold tracking-wider text-slate-400 uppercase">Properties</p>
                    </div>
                </Link>
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-xs font-bold tracking-wider text-slate-400 uppercase">Residents</p>
                    </div>
                </Link>
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-xs font-bold tracking-wider text-slate-400 uppercase">Pending Bills</p>
                    </div>
                </Link>
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-xs font-bold tracking-wider text-slate-400 uppercase">Announcements</p>
                    </div>
                </Link>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div className="flex flex-col rounded-[32px] bg-white p-6 shadow-xs ring-1 ring-slate-100">
                    <div className="flex items-center justify-between">
                        ...
                        <Link
                            href={collectionsIndex.url()}
                            className="text-xs font-bold tracking-wider text-indigo-600 uppercase hover:text-indigo-700"
                        >
                            View All
                        </Link>
                    </div>
                            ...
                            recentPayments.map((p) => (
                                <div key={p.id} className="flex items-center justify-between py-3.5">
                                    ...
                                    <div className="text-right">
                                        <p className="text-sm font-black text-slate-900">₦{Number(p.amount).toLocaleString()}</p>
