                                                    ...
                                                    <div className="flex shrink-0 items-center gap-2">
                                                        {comment.author.id === authUser?.id && (
                                                            <button
                                                                ...
                                                                className="-mt-2 -mr-2 flex min-h-[32px] min-w-[32px] items-center justify-center text-slate-400 hover:text-red-500"
                                                            >
                                                                <Trash2 className="h-3.5 w-3.5" />
                                                            </button>
                                                        )}
                                ...
                                return (
                                    <div key={step.key} className="relative flex gap-5">
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            {!isLast && <div className="my-1 w-0.5 grow bg-slate-100" />}
                                        </div>

                                        {/* Step Content */}
                                        <div className={`flex-1 ${!isLast ? 'pb-8' : ''}`}>
                                            <h4
                                                className={`flex h-7 items-center text-[10px] font-black tracking-wider uppercase ${
                                            ...
                                            <p
                                                className={`mt-0.5 text-xs leading-relaxed ${isCurrent ? 'font-semibold text-slate-600' : isCompleted ? 'text-slate-500' : 'text-slate-400/80'}`}
                                            >
                                                {step.desc}
                                            </p>
                                        </div>
