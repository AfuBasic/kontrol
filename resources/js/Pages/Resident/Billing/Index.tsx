        ...
        <div className="min-h-screen bg-[#f6f8fb] text-slate-950">
            ...
            <main className="mx-auto max-w-5xl px-4 py-4 sm:px-6 sm:py-7 lg:px-8">
                    ...
                    <div className="p-5 sm:p-7">
                        <div className="flex items-center justify-between gap-2">
                            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-black text-white ring-1 ring-white/15">
                                    <span className={`h-1.5 w-1.5 rounded-full ${tone.dot}`} />
                                    {displayLabel}
                                </span>
                                <span className="inline-flex items-center gap-1 rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-bold text-slate-300 ring-1 ring-white/15">
                                    <ShieldCheckIcon className="h-3 w-3" strokeWidth={2.2} />
                                    Secure Gateway
                                </span>
                            </div>
                ...
                <motion.section
                    ...
                    className="mt-5 overflow-hidden rounded-3xl border border-slate-200/70 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_30px_-20px_rgba(15,23,42,0.22)]"
                >
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                                {totalReceipts > 0 ? (
                                    ...
                                    <span className="inline-flex items-center rounded-full bg-slate-50 px-2.5 py-0.5 text-[10px] font-medium whitespace-nowrap text-slate-400">
                                        None
                                    </span>
                                )}
                                <ChevronRightIcon className="h-4 w-4 text-slate-400 group-hover:text-slate-700 group-hover:translate-x-0.5 transition" strokeWidth={2.2} />
