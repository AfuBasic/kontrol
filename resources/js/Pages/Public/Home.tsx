...
export default function Home() {
    ...
    return (
        <PublicLayout>
            ...
            {/* BIG CTA FOOTER */}
            <section className="relative overflow-hidden bg-slate-900 py-40 sm:py-56">
                <div className="absolute inset-0 translate-y-1/2 scale-150 rounded-full bg-blue-600/20 blur-[100px]"></div>
