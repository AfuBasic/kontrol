                ...
                <div className="mx-auto max-w-6xl px-6">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {features.map((f, i) => (
                            <div
                                key={i}
                                className="hover:border-slate-350 flex flex-col gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-8 shadow-sm transition-all dark:border-slate-900 dark:bg-[#0f172a]/20 dark:hover:border-slate-800"
                            >
