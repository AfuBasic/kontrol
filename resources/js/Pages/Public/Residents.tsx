        ...
        <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-[#FF7E67]/30 selection:text-white pb-24">
            ...
            <section className="pt-40 pb-20 relative overflow-hidden border-b border-slate-900">
                ...
                <div className="max-w-4xl mx-auto px-6 text-center flex flex-col gap-6 relative z-10">
                    ...
                    <h1 className="text-4xl sm:text-6xl font-black text-white leading-tight tracking-tight">
                        Your home gate in your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF7E67] to-indigo-400">pocket.</span>
                    </h1>
            ...
            <section className="py-24">
                <div className="max-w-4xl mx-auto px-6">
                    <div className="p-10 bg-gradient-to-br from-[#0f172a]/80 to-[#020617] border border-[#4F46E5]/30 rounded-[40px] flex flex-col items-center text-center justify-between gap-6 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-2 justify-center">
                            <div className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 text-xs font-bold">
