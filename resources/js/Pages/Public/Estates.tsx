...
export default function Estates() {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-[#FF7E67]/30 selection:text-white overflow-hidden pb-12">
            <Head>
            ...
            {/* 1. HERO SECTION */}
            <section className="relative pt-40 pb-20 overflow-hidden border-b border-slate-900/50">
                ...
                <div className="max-w-5xl mx-auto px-6 flex flex-col items-center text-center gap-6 relative z-10">
                    <motion.div 
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#4F46E5]/15 border border-[#4F46E5]/30 text-[#818cf8] text-xs font-bold self-center"
                    >
                    ...
                    <motion.h1 
                        ...
                        className="text-4xl sm:text-6xl font-black text-white leading-tight tracking-tight max-w-4xl"
                    >
                    ...
                    <motion.p 
                        ...
                        className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed font-medium"
                    >
                    ...
                    <motion.div 
                        ...
                        className="mt-16 w-full rounded-2xl border border-slate-900 bg-slate-950/40 p-2 shadow-2xl shadow-[#4F46E5]/10 relative group"
                    >
                        <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-transparent to-transparent z-10 pointer-events-none rounded-xl"></div>
                        <img 
                            src="/assets/images/admin-dashboard-mockup.png" 
                            alt="Kontrol Admin Dashboard Console" 
                            className="w-full h-auto rounded-xl filter brightness-[0.8] group-hover:brightness-[0.95] transition-all duration-700"
                        />
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto px-6 flex flex-col gap-28">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <ul className="flex flex-col gap-3 text-xs text-slate-350 mt-2">
                        ...
                        >
                            ...
                            <div className="relative rounded-3xl border border-slate-900 bg-slate-950/20 p-2 overflow-hidden shadow-2xl">
                                <img 
                                    src="/assets/images/gate-checkpoint-scanner.png" 
                                    alt="Guard scanning QR pass at estate gate" 
                                    className="w-full max-w-md h-auto rounded-2xl object-cover filter brightness-[0.8] hover:scale-[1.03] transition-transform duration-700"
                                />
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div 
                            ...
                            className="relative flex items-center justify-center p-8 border border-red-950 bg-red-950/10 rounded-3xl overflow-hidden group shadow-2xl shadow-red-900/10"
                        >
                            ...
                            <div className="w-full max-w-sm flex flex-col gap-4 text-left font-mono relative z-10">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <span className="text-sm font-black text-white">House 14B, Royal Crescent Street</span>
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    <span className="text-[9px] text-slate-500 uppercase">Primary Owner</span>
                                    <span className="text-xs font-bold text-slate-350">Adeleke Cole (+234 803 123 4567)</span>
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {rolloutSteps.map((s, i) => (
                            <motion.div 
                                ...
                                className="p-6 bg-[#0f172a]/10 border border-slate-950 rounded-2xl flex flex-col gap-4 relative group hover:border-slate-800/40 hover:bg-[#0f172a]/20 transition-all"
                            >
                                <div className="text-3xl font-black text-slate-800/40 group-hover:text-[#FF7E67]/30 transition-colors select-none">{s.number}</div>
            ...
            <section className="py-24">
                <div className="max-w-4xl mx-auto px-6">
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.5 }}
                        className="p-10 bg-gradient-to-br from-[#0f172a]/80 to-[#020617] border border-[#FF7E67]/20 rounded-[40px] flex flex-col items-center text-center justify-between gap-6 shadow-2xl relative overflow-hidden"
                    >
                        ...
                        <div className="max-w-2xl flex flex-col gap-3">
                            ...
                            <p className="text-sm text-slate-400 leading-relaxed font-medium max-w-lg mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-2 w-full justify-center">
                            <Link 
                                href="/apply" 
                                className="px-8 py-4 bg-[#FF7E67] hover:bg-[#ff8f7a] text-white font-extrabold text-sm rounded-xl text-center shadow-lg transition-all flex items-center justify-center gap-2 group"
                            >
                                Onboard Your Estate
