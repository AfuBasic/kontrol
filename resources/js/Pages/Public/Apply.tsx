...
export default function Apply({ plans, flash }: Props) {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-[#FF7E67]/30 selection:text-white">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#020617]/70 backdrop-blur-xl border-b border-slate-900">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <Link href="/" className="text-xs font-semibold text-slate-400 hover:text-white flex items-center gap-1.5 transition-colors">
            ...
            <main className="pt-32 pb-24 relative max-w-4xl mx-auto px-6">
                ...
                <div className="text-center mb-10 flex flex-col gap-3">
                    <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight">Sign up your estate</h1>
                ...
                {/* Main Card Container */}
                <div className="bg-[#0f172a]/20 border border-slate-900 rounded-3xl p-6 sm:p-10 shadow-2xl relative">
                    {flash?.success || wasSuccessful ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-center py-12 gap-5">
                            ...
                            <Link href="/" className="mt-4 px-6 py-3 bg-slate-900 hover:bg-slate-800 text-slate-300 font-bold text-xs rounded-xl border border-slate-800 transition-colors">
                                Back to home page
                            </Link>
                        </div>
                    ) : (
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="estate_name" className="text-xs font-bold text-slate-300 uppercase tracking-wider">Estate name</label>
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-[#020617] border border-slate-900 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-[#4F46E5]/60 transition-colors"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="email" className="text-xs font-bold text-slate-300 uppercase tracking-wider">Contact email</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="phone" className="text-xs font-bold text-slate-300 uppercase tracking-wider">Contact phone</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500">
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="plan_id" className="text-xs font-bold text-slate-300 uppercase tracking-wider">Select plan (Optional)</label>
                                    <div className="relative">
                                        <select 
                                            id="plan_id"
                                            value={data.plan_id}
                                            onChange={e => setData('plan_id', e.target.value)}
                                            className="w-full bg-[#020617] border border-slate-900 rounded-xl py-3 px-4 text-sm text-slate-200 focus:outline-none focus:border-[#4F46E5]/60 transition-colors appearance-none cursor-pointer"
                                        >
                            ...
                            {/* Address Text Area */}
                            <div className="flex flex-col gap-2">
                                <label htmlFor="address" className="text-xs font-bold text-slate-300 uppercase tracking-wider">Estate address (Optional)</label>
                                <div className="relative">
                                    ...
                                    <textarea 
                                        ...
                                        rows={3}
                                        className="w-full bg-[#020617] border border-slate-900 rounded-xl py-3 pl-10 pr-4 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-[#4F46E5]/60 transition-colors resize-none"
                                    />
                                </div>
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="notes" className="text-xs font-bold text-slate-300 uppercase tracking-wider">Additional notes (Optional)</label>
                                <div className="relative">
                                    <div className="absolute top-3.5 left-3.5 text-slate-500">
