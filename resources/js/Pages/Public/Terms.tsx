            ...
            <div className="bg-white py-24 sm:py-32 dark:bg-slate-950">
                <div className="mx-auto max-w-3xl px-6 lg:px-8">
                    <div className="prose prose-slate dark:prose-invert max-w-none">
                        <h1 className="mb-8 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl dark:text-white">Terms of Service</h1>
                        ...
                        <p>
                            These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an
                            entity ("you") and Kontrol ("Company", "we", "us", or "our"), concerning your access to and use of the Kontrol website as
                        ...
                        <p>
                            These Terms shall be governed by and defined following the laws of Nigeria. Kontrol and yourself irrevocably consent that
                            the courts of Nigeria shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these
                            terms.
                        </p>
                        ...
                        <p>
                            ...
                            contact us at: support@kontrol.app
                        </p>
                    </div>
                </div>
            </div>
