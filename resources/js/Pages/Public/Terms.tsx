                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm lg:p-12">
                                ...
                                <section>
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        By accessing or using Kontrol (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If
                                        you disagree with any part of these terms, you may not access the Service.
                                    </p>
                                    <p className="mt-4 text-slate-600">
                                        These Terms apply to all visitors, users, and others who access or use the Service, including residents,
                                        security personnel, and estate administrators.
                                    </p>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">Kontrol is an estate access management platform that enables:</p>
                                ...
                                <section className="mt-10">
                                    ...
                                    <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-600">
                                        ...
                                        <li>Generate access codes only for legitimate visitors whom you are authorized to invite</li>
                                        <li>Not share your account credentials with others</li>
                                        <li>Not attempt to gain unauthorized access to any part of the Service or other accounts</li>
                                        <li>Not use the Service to transmit malicious code, spam, or harmful content</li>
                                ...
                                <section className="mt-10">
                                    ...
                                    <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-600">
                                        ...
                                        <li>Harass, abuse, threaten, or intimidate other users or third parties</li>
                                        ...
                                        <li>Circumvent any access control, security, or usage limitation features</li>
                                    </ul>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-600">
                                        <li>Ensure that all users within your estate are authorized to use the Service</li>
                                        <li>Manage user roles and permissions responsibly</li>
                                        <li>Respond to user inquiries and access requests in a timely manner</li>
                                        <li>Maintain accurate estate information within the Service</li>
                                        <li>Comply with applicable data protection laws regarding resident data</li>
                                        <li>Not use the Service to discriminate against or unfairly treat any individual</li>
                                    </ul>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        ...
                                        of Kontrol and its licensors. The Service is protected by copyright, trademark, and other laws.
                                    </p>
                                    <p className="mt-4 text-slate-600">
                                        Our trademarks and trade dress may not be used in connection with any product or service without prior written
                                        consent. You are granted a limited, non-exclusive, non-transferable license to use the Service for its
                                        intended purpose.
                                    </p>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        You retain ownership of any data you submit to the Service. By submitting data, you grant us a license to use,
                                        store, and process that data to provide the Service to you.
                                    </p>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        We do not guarantee that the Service will meet your specific requirements or achieve any particular results.
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        TO THE MAXIMUM EXTENT PERMITTED BY LAW, KONTROL AND ITS DIRECTORS, EMPLOYEES, PARTNERS, AGENTS, SUPPLIERS, OR
                                    ...
                                    <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-600">
                                        ...
                                        <li>Any security breaches or failures of third-party systems</li>
                                        <li>Any physical security incidents at your estate, even if the Service was used</li>
                                    </ul>
                                    <p className="mt-4 text-slate-600">
                                        The Service is a tool to assist with access management. Ultimate responsibility for estate security remains
                                        with the estate and its authorized personnel.
                                    </p>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        You agree to defend, indemnify, and hold harmless Kontrol and its affiliates, directors, officers, employees,
                                        and agents from any claims, damages, liabilities, costs, or expenses (including reasonable attorneys' fees)
                                        arising from:
                                    </p>
                                    <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-600">
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        ...
                                        Kontrol operates, without regard to its conflict of law provisions.
                                    </p>
                                    <p className="mt-4 text-slate-600">
                                        Any disputes arising from these Terms or the Service shall be resolved through binding arbitration or in the
                                        courts of competent jurisdiction, at our discretion.
                                    </p>
                                </section>
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        Your continued use of the Service after any changes constitutes acceptance of the new Terms. If you do not
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        If any provision of these Terms is held to be unenforceable or invalid, such provision will be modified to the
                                        minimum extent necessary to make it enforceable, or if modification is not possible, severed from these Terms.
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">
                                        ...
                                        constitute the entire agreement between you and Kontrol concerning the Service and supersede all prior
                                ...
                                <section className="mt-10">
                                    ...
                                    <p className="mt-4 text-slate-600">If you have any questions about these Terms, please contact us:</p>
                                    <ul className="mt-4 list-disc space-y-2 pl-6 text-slate-600">
                                        <li>
                                            <strong>Email:</strong>{' '}
