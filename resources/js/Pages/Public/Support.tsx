                    ...
                    <div className="mx-auto max-w-2xl">
                        ...
                        >
                            <a 
                                ...
                                className="group rounded-3xl bg-white p-8 text-center shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 transition-all hover:-translate-y-1 hover:shadow-2xl dark:bg-slate-900 dark:shadow-none dark:ring-slate-800 dark:hover:ring-blue-500/50"
                            >
                            ...
                            <a 
                                ...
                                className="group rounded-3xl bg-white p-8 text-center shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 transition-all hover:-translate-y-1 hover:shadow-2xl dark:bg-slate-900 dark:shadow-none dark:ring-slate-800 dark:hover:ring-green-500/50"
                            >
