...
export default function EditReferrer({ referrer }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        put(`/zeus/referrers/${referrer.id}`);
    }

    return (
        <ZeusLayout>
            <Head title={`Edit Referrer — ${referrer.name}`} />
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-2xl">
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                    <h1 className="mb-2 text-3xl font-bold text-gray-900">Edit Referrer</h1>
                    <p className="mb-8 text-gray-600">Update referrer partner information</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 transition-colors placeholder:text-gray-400 focus:border-primary-400 focus:ring-2 focus:ring-primary-500/20 focus:outline-none"
                                    placeholder="contact@referrer.com"
                                />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 transition-colors placeholder:text-gray-400 focus:border-primary-400 focus:ring-2 focus:ring-primary-500/20 focus:outline-none"
                                placeholder="Brief description of the referrer"
                            />
                        </div>
