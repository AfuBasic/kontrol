        ...
        <ZeusLayout>
            ...
            <div className="relative mx-auto max-w-4xl px-4 py-8">
                ...
                <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="mb-8">
                    <a
                        href="/zeus/coupons"
                        className="group inline-flex items-center gap-2 text-xs font-bold tracking-widest text-slate-500 uppercase transition-all hover:text-slate-950 dark:text-slate-400 dark:hover:text-white"
                    >
                                    ...
                                    <button
                                        ...
                                        className={`group relative flex cursor-pointer flex-col rounded-2xl border-2 p-5 text-left transition-all ${
                                            isSelected
                                                ...
                                                : 'border-slate-200 bg-slate-50/50 hover:border-slate-300 dark:border-slate-800 dark:bg-[#080b13] dark:hover:border-slate-700'
                                        }`}
                                    >
                                        <div
                        ...
                        <AnimatePresence mode="wait">
                                        ...
                                        <div className="relative">
                                            <div className="relative flex overflow-hidden rounded-xl border border-slate-200 bg-slate-50/50 transition-all focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 dark:border-slate-800 dark:bg-[#080b13]">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-transparent px-3 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none dark:text-white"
                                                />
                                            </div>

                                            {/* Autocomplete Dropdown list */}
                                            {filteredEstates.length > 0 && (
                                                <div className="absolute right-0 left-0 z-20 mt-1.5 max-h-60 divide-y divide-slate-100 overflow-hidden overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-lg dark:divide-slate-800/60 dark:border-slate-800 dark:bg-[#0f1423]">
                            ...
                            {data.scope === 'resident' && (
                                ...
                                >
                                                ...
                                                <div className="absolute right-0 left-0 z-20 mt-1.5 max-h-60 divide-y divide-slate-100 overflow-hidden overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-lg dark:divide-slate-800/60 dark:border-slate-800 dark:bg-[#0f1423]">
                                                    {filteredResidents.map((resident) => (
                                                        <div
                                                            ...
                                                            className="flex cursor-pointer flex-col px-4 py-3 text-left transition hover:bg-slate-50 dark:hover:bg-slate-800/40"
                                                        >
                                                            <span className="text-sm font-bold text-slate-700 dark:text-slate-300">
                                                                {resident.name}
                                                            </span>
                                                            <span className="dark:text-slate-555 mt-0.5 text-xs text-slate-500">
                                                                {resident.email}
                                                            </span>
                                                        </div>
                                                    ))}
                                    ...
                                    {(localErrors.user_id || errors.user_id) && (
                                        <p className="mt-1.5 text-xs font-semibold text-rose-500">{localErrors.user_id || errors.user_id}</p>
                                    )}
                                </motion.div>
                            )}
                        </AnimatePresence>
