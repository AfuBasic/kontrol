...
export default function AdminActivation({ acceptUrl, user, flash, errors, estate_name }: Props) {
    ...
    return (
        <>
            <Head title="Activate Administrator Account - Kontrol" />
                                ...
                                >
                                    <span className="relative z-10 flex items-center justify-center gap-2">
                                        {processing ? (
                                            ...
                                            <>
                                                Activate my administrator account
