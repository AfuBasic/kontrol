            ...
            <div className="mx-auto max-w-xl space-y-6 pb-20 sm:pb-16">
                ...
                <div className="flex items-center gap-3 pt-1">
                    <button
                        ...
                        onClick={handleBack}
                        aria-label="Go back"
                        className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200/80 bg-white text-slate-700 shadow-xs transition hover:bg-slate-50 active:scale-95 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800/80"
                    >
                        <ArrowLeft className="h-5 w-5" />
                    </button>
                    <span className="text-xs font-semibold tracking-widest text-slate-500 uppercase dark:text-slate-400">Help & Feedback</span>
                </div>

                {/* Header */}
                <header className="space-y-1.5 px-0.5">
                    <h1 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl dark:text-white">Help & Support</h1>
                ...
                <div className="space-y-2.5">
                    <h2 className="px-1 text-xs font-semibold tracking-wider text-slate-500 uppercase dark:text-slate-400">Contact Support</h2>
                    <section aria-label="Support contact options">
                        <div className="divide-y divide-slate-100 overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-xs dark:divide-slate-800/70 dark:border-slate-800 dark:bg-slate-900">
                            {/* WhatsApp Support */}
                            <a
                                href={whatsappUrl}
                                target="_blank"
                                ...
                                className="group flex min-h-[64px] items-center justify-between gap-3.5 px-4 py-3.5 transition-colors hover:bg-slate-50/70 active:bg-slate-50 sm:px-5 dark:hover:bg-slate-800/40 dark:active:bg-slate-800/80"
                            >
                                <div className="flex min-w-0 items-center gap-3.5">
                                    ...
                                    <div className="min-w-0">
                                        <div className="text-sm font-semibold text-slate-900 dark:text-white">Chat on WhatsApp</div>
                            ...
                            >
                                <div className="flex min-w-0 items-center gap-3.5">
                                    ...
                                    <div className="min-w-0">
                                        <div className="text-sm font-semibold text-slate-900 dark:text-white">Call Support</div>
                                        <p className="truncate text-xs font-medium text-slate-500 dark:text-slate-400">{support.phone_formatted}</p>
                                    </div>
                                </div>
                                <ChevronRight className="h-5 w-5 shrink-0 text-slate-400 transition-transform group-hover:translate-x-0.5 group-hover:text-slate-600 dark:text-slate-500 dark:group-hover:text-slate-300" />
                            </a>
                            ...
                            >
                                <div className="flex min-w-0 items-center gap-3.5">
                                    ...
                                    <div className="min-w-0">
                                        <div className="text-sm font-semibold text-slate-900 dark:text-white">Email Support</div>
                                        <p className="truncate text-xs font-medium text-slate-500 dark:text-slate-400">{support.email}</p>
                                    </div>
                                </div>
                                <ChevronRight className="h-5 w-5 shrink-0 text-slate-400 transition-transform group-hover:translate-x-0.5 group-hover:text-slate-600 dark:text-slate-500 dark:group-hover:text-slate-300" />
                            </a>
                ...
                <div className="space-y-2.5">
                    <h2 className="px-1 text-xs font-semibold tracking-wider text-slate-500 uppercase dark:text-slate-400">Product Feedback</h2>
                    <section aria-label="Product feedback">
                        <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-xs dark:border-slate-800 dark:bg-slate-900">
                            <button
                                type="button"
                                onClick={() => setIsFeedbackOpen(true)}
                                className="group flex min-h-[64px] w-full items-center justify-between gap-3.5 px-4 py-3.5 text-left transition-colors hover:bg-slate-50/70 active:bg-slate-50 sm:px-5 dark:hover:bg-slate-800/40 dark:active:bg-slate-800/80"
                            >
                                <div className="flex min-w-0 items-center gap-3.5">
                                    ...
                                    <div className="min-w-0">
                                        <div className="text-sm font-semibold text-slate-900 dark:text-white">Send Feedback</div>
                                        <p className="truncate text-xs font-medium text-slate-500 dark:text-slate-400">
                ...
                {isNative && (
                    <div className="space-y-2.5">
                        <h2 className="px-1 text-xs font-semibold tracking-wider text-slate-500 uppercase dark:text-slate-400">App Rating</h2>
                                    ...
                                    <div className="flex min-w-0 items-center gap-3.5">
                                        ...
                                        <div className="min-w-0">
                                            <div className="text-sm font-semibold text-slate-900 dark:text-white">
                                                {nativePlatform === 'android' ? 'Rate Kontrol on Google Play' : 'Rate Kontrol on the App Store'}
                                            </div>
                                            <p className="truncate text-xs font-medium text-slate-500 dark:text-slate-400">
                ...
                <section aria-label="Support guidance">
                    <div className="flex items-start gap-3.5 rounded-2xl border border-slate-200/60 bg-slate-50/70 p-4 dark:border-slate-800/60 dark:bg-slate-900/40">
                        ...
                        <div className="space-y-1">
                            <h3 className="text-xs font-semibold text-slate-900 dark:text-white">Before contacting support</h3>
                            <p className="text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                                If you're reporting a malfunction, mentioning what you were doing right before helps our support engineers resolve it
                                immediately.
                            </p>
                        </div>
                    </div>
