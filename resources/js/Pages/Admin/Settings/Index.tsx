        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <motion.div
                    ...
                    className="mb-6 rounded-xl border border-gray-200 bg-white p-6"
                >
                    <h2 className="mb-6 text-lg font-medium text-gray-900">Subscription & Onboarding</h2>

                    <div className="space-y-6">
                        {/* Free Trial Toggle */}
                        <div className="flex items-start justify-between">
                            <div>
                                <h3 className="text-sm font-medium text-gray-900">Resident Free Trial</h3>
                                <p className="mt-1 text-sm text-gray-500">
                                    When enabled, new residents start with a trial period before being required to pay.
                                </p>
                            </div>
                            <label className="relative inline-flex cursor-pointer items-center">
                                <input
                        ...
                        {data.free_trial_enabled && (
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 block w-full max-w-xs rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 focus:outline-none"
                                />
                                <p className="mt-1 text-xs text-gray-500">Number of days a resident can use the app for free after joining.</p>
                        ...
                        <div className="border-t border-gray-100 pt-6">
                            ...
                            />
                            <p className="mt-1 text-xs text-gray-500">
                                Extra time granted to pay before access is restricted (applies if no trial or after trial ends).
                            </p>
