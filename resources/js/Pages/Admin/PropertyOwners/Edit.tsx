            ...
            >
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        {errors.email && <p className="text-red-650 mt-1 text-sm">{errors.email}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                        />
                        {errors.name && <p className="text-red-660 mt-1 text-sm">{errors.name}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="+234..."
                        />
                        {errors.phone && <p className="text-red-670 mt-1 text-sm">{errors.phone}</p>}
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            />
                            {errors.unit_number && <p className="text-red-680 mt-1 text-sm">{errors.unit_number}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.address && <p className="text-red-690 mt-1 text-sm">{errors.address}</p>}
                        </div>
                    </div>
                </div>
