            ...
            >
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        {errors.email && <p className="mt-1 text-sm text-red-650">{errors.email}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                        />
                        {errors.name && <p className="mt-1 text-sm text-red-660">{errors.name}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="+234..."
                        />
                        {errors.phone && <p className="mt-1 text-sm text-red-670">{errors.phone}</p>}
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            ...
                            />
                            {errors.unit_number && <p className="mt-1 text-sm text-red-680">{errors.unit_number}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.address && <p className="mt-1 text-sm text-red-690">{errors.address}</p>}
                        </div>
                    </div>
                </div>
