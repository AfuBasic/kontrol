...
export default function InviteLinkManagement({ inviteLink }: Props) {
    ...
    const handleToggleLink = () => {
        router.post(inviteLinkToggle.url(), {}, { preserveScroll: true });
    };
    ...
    return (
        <>
            <Head title="Manage Property Owner Invite Link" />
            ...
            <div className="mx-auto max-w-3xl">
                ...
                <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">Property Owner Invite Link</h1>
                        <p className="mt-1 text-gray-500">Configure and monitor your public property owner invite link.</p>
                    </div>
                    {!inviteLink && (
                        <Link
                            href={propertyOwnersCreate.url()}
                            className="inline-flex items-center gap-2 rounded-lg bg-[#1F6FDB] px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-slate-800"
                        >
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <div className="flex items-start justify-between">
                                <div className="flex items-center gap-4">
                                    <div
                                        className={`flex h-12 w-12 items-center justify-center rounded-xl ${inviteLink.is_active ? 'bg-green-50 text-green-600' : 'bg-gray-50 text-gray-400'}`}
                                    >
                            ...
                            <div className="mt-8">
                                <div className="group relative">
                                    <input
                                        ...
                                        className="w-full rounded-xl border border-gray-200 bg-gray-50 px-5 py-4 pr-36 font-mono text-sm text-gray-600 shadow-inner transition-all outline-none focus:border-primary-300"
                                    />
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition-colors hover:text-[#1F6FDB]"
                                    >
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                            ...
                            >
                                ...
                                <p className="text-[10px] font-bold tracking-widest text-gray-400 uppercase">Total Signups</p>
                                <div className="mt-1 flex items-baseline gap-1">
                                    <p className="text-2xl font-bold text-gray-900">{inviteLink.usage_count}</p>
                                    {inviteLink.max_usages && <p className="text-sm text-gray-400">/ {inviteLink.max_usages} max</p>}
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-[10px] font-bold tracking-widest text-gray-400 uppercase">Approval Mode</p>
                                <p className="mt-1 text-lg font-bold text-gray-900">{inviteLink.requires_approval ? 'Manual' : 'Automatic'}</p>
                            ...
                            >
                                ...
                                <p className="text-[10px] font-bold tracking-widest text-gray-400 uppercase">Expiration</p>
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-red-700">Deleting the link will permanently disable it. This cannot be undone.</p>
                                </div>
                                <div className="group relative">
                                    <button
                                        disabled={inviteLink.is_active}
                                        onClick={() => setShowDeleteConfirm(true)}
                                        className={`inline-flex shrink-0 items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-bold transition-all ${
                                            inviteLink.is_active
                                    ...
                                    {inviteLink.is_active && (
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 rounded bg-gray-900 px-2 py-1 text-[10px] whitespace-nowrap text-white opacity-0 transition-opacity group-hover:opacity-100">
...
InviteLinkManagement.layout = (page: any) => <AdminLayout title="Property Owners Invite Link" children={page} />;
