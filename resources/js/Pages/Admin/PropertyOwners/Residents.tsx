                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <div className="flex items-center gap-2 text-sm text-slate-500">
                            ...
                            <span>/</span>
                            <span className="font-bold text-slate-850">Residents</span>
                        </div>
                ...
                <div className="overflow-hidden rounded-[32px] bg-white shadow-xs ring-1 ring-slate-100">
                    {residents.length > 0 ? (
                                        ...
                                        <tr key={resident.id} className="transition-colors hover:bg-slate-50/50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                {resident.property ? (
                                                    ...
                                                    <span className="text-xs italic text-slate-400 font-bold">Unassigned</span>
                                                )}
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-[10px] font-black tracking-widest uppercase ${
                        ...
                        <div className="py-16 text-center">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                This Property Owner has no delegated occupants yet.
                            </p>
                            <div className="mt-6">
                                <Link
                                    href={createResident.url()}
                                    className="inline-flex items-center rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-indigo-750 transition-all"
                                >
                                    Delegate a Resident
                                </Link>
                            </div>
