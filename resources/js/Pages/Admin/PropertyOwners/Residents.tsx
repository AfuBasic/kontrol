...
import { Users, MapPin, Mail, Phone, UserPlus, Search, Building2, Eye, Plus, X } from 'lucide-react';
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <div className="flex flex-wrap items-center gap-1.5 text-xs text-slate-500">
                            <Link
                                href={index.url()}
                                className="font-semibold transition-colors hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-400"
                            >
                                Property Owners
                            </Link>
                        ...
                        <p className="mt-0.5 text-xs font-semibold text-slate-500 dark:text-slate-400">
                            Listing all occupants delegated to{' '}
                            <span className="font-bold text-slate-700 dark:text-slate-300">{propertyOwner.name}</span>.
                        </p>
                    </div>
                                        ...
                                        {residentList.map((res) => (
                                            <div key={res.id} className="space-y-3 py-3.5 first:pt-1 last:pb-1">
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="min-w-0">
                                                            <Link
                                                                ...
                                                                className="truncate text-sm font-bold text-slate-900 hover:text-indigo-600 dark:text-slate-100 dark:hover:text-indigo-400"
                                                            >
                                                                {res.name}
                                                            </Link>
                                                    ...
                                                    <span
                                                        className={`inline-flex items-center rounded-full border px-2 py-0.5 text-[10px] font-bold tracking-wider uppercase ${getStatusBadge(res)}`}
                                                    >
                                                ...
                                                {residentList.map((resident) => (
                                                    ...
                                                    >
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <div className="flex items-center gap-3">
                                                                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-indigo-50 text-xs font-bold text-indigo-700 dark:bg-indigo-950/50 dark:text-indigo-300">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <span
                                                                className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-[10px] font-bold tracking-wider uppercase ${getStatusBadge(resident)}`}
                                                            >
                ...
                <div className="p-6 dark:bg-slate-900">
                    <div className="flex items-center justify-between border-b border-slate-100 pb-3 dark:border-slate-800">
                        <div>
                            ...
                            <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                                Search and select existing residents in the estate to assign them to{' '}
                                <span className="font-semibold text-slate-700 dark:text-slate-300">{propertyOwner.name}</span>.
                            </p>
                        </div>
                        <button
                    ...
                    <div className="mt-5 space-y-3 border-t border-slate-100 pt-3.5 dark:border-slate-800">
                        <div className="flex items-center justify-between text-xs">
                            ...
                            <span
                                className={`font-bold ${selectedIds.length > 0 ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 dark:text-slate-500'}`}
                            >
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                type="button"
                                onClick={() => setIsAssignModalOpen(false)}
                                className="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-center text-xs font-bold whitespace-nowrap text-slate-700 shadow-xs hover:bg-slate-50 active:scale-95 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-indigo-600 px-4 py-2.5 text-center text-xs font-bold whitespace-nowrap text-white shadow-xs hover:bg-indigo-700 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                            >
