                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                                            ...
                                            <div className="grid grid-cols-3 gap-4 lg:gap-6">
                                                ...
                                                <div className="text-center lg:text-right">
                                                    <p className="mb-1 text-[9px] font-bold tracking-widest text-emerald-400/60 uppercase">
                                                        Collected
                                                    </p>
                                                ...
                                                <div className="text-center lg:text-right">
                                                    <p className="mb-1 text-[9px] font-bold tracking-widest text-rose-400/60 uppercase">
                                                        Outstanding
                                                    </p>
                                                ...
                                                <div className="space-y-2">
                                                    <div className="flex items-center justify-between rounded-xl bg-emerald-50 px-4 py-3">
                                                        <div>
                                                            ...
                                                            <p className="text-lg font-black text-emerald-700">
                                                                {fmtCompact(todaySnapshot.collected_today)}
                                                            </p>
                                                        </div>
                                                    ...
                                                    <div className="rounded-xl bg-blue-50 px-4 py-3">
                                                        ...
                                                        <p className="text-base font-black text-blue-700">
                                                            {fmtCompact(todaySnapshot.collected_this_week)}
                                                        </p>
                                                        <p className="text-[10px] text-blue-400">
                                                            {todaySnapshot.payments_this_week} payment
                                                            {todaySnapshot.payments_this_week !== 1 ? 's' : ''}
                                                        </p>
                                                    </div>
                                                </div>
                                            )}
                                        ...
                                        >
                                            {collectionInsights && (
                                                <div className="grid gap-3 sm:grid-cols-3">
                                                        ...
                                                        >
                                                            ...
                                                            <p className="mt-1 text-[10px] font-medium text-emerald-600/70">
                                                                {collectionInsights.best.total_count -
                                                                    Math.round(
                                                                        collectionInsights.best.total_count *
                                                                            (1 - collectionInsights.best.rate / 100),
                                                                    )}{' '}
                                                    ...
                                                    {/* Largest Outstanding */}
                                                    {collectionInsights.largest_outstanding &&
                                                    collectionInsights.largest_outstanding.outstanding > 0 ? (
                                                        <Link
