        ...
        <>
            ...
            <div className="mx-auto max-w-4xl">
                <div className="mb-8">
                    ...
                    <h1 className="text-4xl font-black tracking-tight text-slate-900">Edit Collection</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                    ...
                    <div className="rounded-[2.5rem] border border-slate-200 bg-white p-10 shadow-sm ring-1 ring-slate-100">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <h2 className="text-xl font-black tracking-tight text-slate-900">Basic Information</h2>
                        </div>
                    ...
                    <div className="rounded-[2.5rem] border border-slate-200 bg-white p-10 shadow-sm ring-1 ring-slate-100">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <h2 className="text-xl font-black tracking-tight text-slate-900">Schedule & Rules</h2>
                        </div>
                    ...
                    <div className="rounded-[2.5rem] border border-slate-200 bg-white p-10 shadow-sm ring-1 ring-slate-100">
                        <div className="mb-8 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <h2 className="text-xl font-black tracking-tight text-slate-900">Target Audience</h2>
                            </div>
                            <div className="relative">
                                <select
...
EditCollection.layout = (page: any) => <AdminLayout children={page} />;
