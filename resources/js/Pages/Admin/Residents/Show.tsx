...
export default function Show({ resident, provenance, residence, financials, activities }: Props) {
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in">
                ...
                {/* Hero Header Card */}
                <div className="relative overflow-hidden rounded-3xl border border-slate-100 bg-linear-to-r from-slate-900 via-slate-800 to-slate-900 p-6 sm:p-8 text-white shadow-md">
                    ...
                    <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-1">
                                <div className="flex flex-wrap items-center gap-2">
                                    <h1 className="text-xl sm:text-2xl font-black tracking-tight">{resident.name}</h1>
                                    <span className="inline-flex items-center rounded-md bg-white/10 px-2 py-0.5 text-xs font-bold text-white uppercase backdrop-blur-xs ring-1 ring-white/15">
                                        {resident.role_label}
                                    </span>
                                    {resident.is_active ? (
                        ...
                        <div className="rounded-2xl bg-white/5 p-4.5 backdrop-blur-xs ring-1 ring-white/10 space-y-3 min-w-[200px]">
                            <span className="text-[10px] font-black tracking-widest text-slate-400 uppercase block">Account Setup State</span>
                    ...
                    <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-xs space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div>
                                    <span className={`inline-flex items-center rounded-md px-2.5 py-0.5 text-xs font-black tracking-wide uppercase ring-1 ${getAvenueColor(provenance.created_via)}`}>
                                        {provenance.avenue}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 pt-2">
                                ...
                                {provenance.last_invited_at && (
                                    <div className="flex flex-col gap-1 border-l-2 border-slate-100 pl-3">
                                        <div className="flex justify-between items-center text-xs">
                                            <span className="font-bold text-slate-400 text-[10px] uppercase">Last Resent By:</span>
                                            <span className="font-semibold text-slate-700">{provenance.last_invited_by_name || 'System'}</span>
                                        </div>
                                        <div className="flex justify-between items-center text-xs">
                                            <span className="font-bold text-slate-400 text-[10px] uppercase">Last Resent At:</span>
                            ...
                            {provenance.import_batch && (
                                <div className="rounded-2xl border border-purple-100 bg-purple-50/20 p-3 space-y-1">
                                    <span className="text-[9px] font-black tracking-widest text-purple-400 uppercase block">Import Batch</span>
                            ...
                            {provenance.invite_link_url && (
                                <div className="rounded-2xl border border-pink-100 bg-pink-50/20 p-3 space-y-1">
                                    <span className="text-[9px] font-black tracking-widest text-pink-400 uppercase block">Via Invite Link</span>
                                    <a
                                        href={provenance.invite_link_url}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-1 text-xs font-bold text-pink-850 hover:underline"
                                    >
                            ...
                            {provenance.invitation && (
                                <div className="rounded-2xl border border-blue-100 bg-blue-50/20 p-3 space-y-1 text-xs">
                                    <span className="text-[9px] font-black tracking-widest text-blue-400 uppercase block">Invitation Token details</span>
                                    <div className="flex items-center justify-between text-blue-900">
                                        <span className="font-bold">Token:</span>
                                        <code className="rounded bg-white/70 px-1 font-mono text-[10px] ring-1 ring-blue-600/5">{provenance.invitation.token.slice(0, 10)}...</code>
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-xs space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="rounded-2xl border border-slate-50 bg-slate-50/30 p-3 space-y-1.5">
                            ...
                            <div className="space-y-1">
                                ...
                                {residence.property_owner_name ? (
                                    ...
                                    <div className="text-xs font-bold text-slate-400">
                                        None (Direct Property Owner or independent profile)
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-xs space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="rounded-2xl border border-emerald-100 bg-emerald-50/20 p-3 text-center">
                                <span className="text-[9px] font-black tracking-widest text-emerald-500 uppercase block">Total Paid</span>
                            ...
                            <div className="rounded-2xl border border-rose-100 bg-rose-50/20 p-3 text-center">
                                <span className="text-[9px] font-black tracking-widest text-rose-500 uppercase block">Outstanding</span>
                        ...
                        <div className="space-y-3">
                            <span className="text-[10px] font-black tracking-widest text-slate-400 uppercase block">Recent Payments</span>
                            {financials.recent_payments.length > 0 ? (
                                <div className="space-y-2 max-h-36 overflow-y-auto">
                                    {financials.recent_payments.map((p) => (
                                        <div key={p.id} className="flex justify-between items-center rounded-xl border border-slate-50 bg-slate-50/20 p-2.5 text-xs">
                                ...
                                <div className="text-xs font-semibold text-slate-400 text-center py-2">
                            ...
                            <div className="space-y-3 pt-2 border-t border-slate-50">
                                ...
                                <div className="space-y-2 max-h-36 overflow-y-auto">
                                    {financials.property_owner_financials.map((po) => (
                                        <div key={po.id} className="flex justify-between items-center rounded-xl border border-slate-50 bg-slate-50/20 p-2.5 text-xs">
                                            <div className="min-w-0">
                                                <div className="font-bold text-slate-800 truncate">{po.name}</div>
                                                <div className="text-[9px] text-slate-400">
                                                    Paid: ₦{po.amount_paid.toLocaleString()} / Due: ₦{po.amount_due.toLocaleString()}
                                                </div>
                                            </div>
                                            {po.outstanding > 0 ? (
                                                <div className="font-bold text-rose-500 shrink-0 text-right">
                ...
                <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-xs space-y-6">
                    ...
                    {activities.length > 0 ? (
                        <div className="relative pl-6 space-y-6 border-l-2 border-slate-100 py-2 ml-3">
                            {activities.map((act) => (
                                <div key={act.id} className="relative">
                                    {/* Timeline Marker Dot */}
                                    <div className="absolute -left-9 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 text-slate-500 ring-4 ring-white">
