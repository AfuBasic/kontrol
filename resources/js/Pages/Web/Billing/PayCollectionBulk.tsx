...
export default function PayCollectionBulk({ assignments, paystackKey, totalAmount }: Props) {
                    ...
                    <div className="space-y-6">
                        <div className="rounded-3xl bg-slate-50 p-8 ring-1 ring-slate-100">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-3xl font-black tracking-tight text-slate-900">{formatCurrency(totalAmount)}</span>
                            </div>
                        </div>
