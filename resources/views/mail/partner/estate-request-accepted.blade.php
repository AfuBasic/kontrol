...
@section('content')
    ...
    <p>Great news — your estate onboarding request for <span class="bold">{{ $estateName }}</span> has been approved by our team.</p>

    <p>We've created the estate workspace and sent an invitation to the estate contact so they can finish setup. You'll start earning commission once residents are active on Kontrol, per your partner agreement.</p>
    ...
    <p style="font-size: 14px; color: #64748b;">View this estate in your <a href="{{ url('/partner/partner-requests') }}">My Estates</a> pipeline or check <a href="{{ url('/partner/earnings') }}">Earnings</a> as activity starts.</p>
@endsection
