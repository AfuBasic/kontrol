...
@section('content')
    <div class="badge" style="background-color: #fefcf1; color: #92400e; border: 1px solid #fde68a;">Welcome</div>
    ...
    <div class="button-container">
        <a href="{{ $invitationUrl }}" class="button shadow" style="background-color: #1e293b; box-shadow: 0 4px 14px 0 rgba(30, 41, 59, 0.3);">Login Now</a>
    </div>
