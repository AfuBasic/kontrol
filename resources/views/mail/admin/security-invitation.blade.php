...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            @if($isPasswordReset ?? false)
                <p>
                    A password reset was requested for your security account at <strong>{{ $estateName }}</strong>.
            ...
            @else
                <p>
                    You've been invited to join <strong>{{ $estateName }}</strong> as a Security Personnel on {{ config('app.name') }}.
                    To complete your registration and get started, please set up your password by clicking the button below.
                </p>
                <div class="role-badge">🔒 Security Personnel</div>
            ...
            @if(!($isPasswordReset ?? false))
                <p style="background-color: #fef2f2; border-left: 4px solid #dc2626; padding: 15px; border-radius: 4px; color: #7f1d1d; font-size: 13px;">
                    <strong>💡 What happens next?</strong><br>
                    Once you set up your password, you'll have access to the security dashboard where you can manage access logs, respond to incidents, and coordinate with the estate administration.
                </p>
            @endif
