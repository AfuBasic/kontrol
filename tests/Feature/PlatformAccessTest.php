...
test('property_owner on iphone mobile browsers is restricted and redirected to ios app store experience', function () {
    $estate = Estate::factory()->create();
    ...
    $service = app(PlatformAccessService::class);
    $result = $service->evaluate($requestIosBrowser, $owner);
